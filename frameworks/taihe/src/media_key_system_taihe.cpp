...
const std::unordered_map<DrmInnerErrCode, DrmTaiheErrCode>
    INNERCODE_TO_API12_TAIHECODE = {
    {DRM_INNER_ERR_OK,                                           DRM_TAIHE_ERR_OK},
    {DRM_INNER_ERR_UNKNOWN,                                 DRM_TAIHE_ERR_UNKNOWN},
    {DRM_INNER_ERR_MAX_SYSTEM_NUM_REACHED,   DRM_TAIHE_ERR_MAX_SYSTEM_NUM_REACHED},
    {DRM_INNER_ERR_MAX_SESSION_NUM_REACHED, DRM_TAIHE_ERR_MAX_SESSION_NUM_REACHED},
    {DRM_INNER_ERR_INVALID_VAL,                         DRM_TAIHE_ERR_INVALID_VAL},
    {DRM_INNER_ERR_SERVICE_DIED,                      DRM_TAIHE_ERR_SERVICE_FATAL},
    {DRM_INNER_ERR_SERVICE_FATAL_ERROR,               DRM_TAIHE_ERR_SERVICE_FATAL},
};
...
MediaKeySystemImpl::MediaKeySystemImpl()
{
    ...
    ObjectRefMap<MediaKeySystemImpl>::Insert(this);
}
...
MediaKeySystemImpl::~MediaKeySystemImpl()
{
    ...
    ObjectRefMap<MediaKeySystemImpl>::DecreaseRef(this);
}
...
static array<StatisticKeyValue> vectorToTaiheArray(
    std::vector<OHOS::DrmStandard::IMediaKeySystemService::MetircKeyValue> &metrics)
{
...
ContentProtectionLevel MediaKeySystemImpl::GetMaxContentProtectionLevel()
{
    ...
    OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel level =
        OHOS::DrmStandard::IMediaKeySessionService::CONTENT_PROTECTION_LEVEL_UNKNOWN;
    ContentProtectionLevel::key_t contentProtectionLevel;
    DrmTaiheUtils::GetEnumKeyByValue<ContentProtectionLevel>(level, contentProtectionLevel);
    if (mediaKeySystemImpl_ != nullptr) {
...
ProvisionRequest MediaKeySystemImpl::GenerateKeySystemRequestSync()
{
    ...
    ObjectRefMap objectGuard(this);
    auto *mediaKeySystemTaihe = objectGuard.GetPtr();
    if (mediaKeySystemTaihe != nullptr && mediaKeySystemTaihe->mediaKeySystemImpl_ != nullptr) {
        int32_t ret = mediaKeySystemTaihe->mediaKeySystemImpl_->GenerateKeySystemRequest(
            mediaKeySystemTaihe->provisionRequest.data, mediaKeySystemTaihe->provisionRequest.defaultURL);
        if (ret != OHOS::DrmStandard::DRM_INNER_ERR_OK) {
    ...
    ProvisionRequest provisionRequestInfo {
        array<uint8_t>(mediaKeySystemTaihe->provisionRequest.data),
        DrmTaiheUtils::ToTaiheString(mediaKeySystemTaihe->provisionRequest.defaultURL),
    };
...
void MediaKeySystemImpl::ProcessKeySystemResponseSync(array_view<uint8_t> response)
{
    ...
    if (mediaKeySystemTaihe != nullptr && mediaKeySystemTaihe->mediaKeySystemImpl_ != nullptr) {
        int32_t ret = mediaKeySystemTaihe->mediaKeySystemImpl_->ProcessKeySystemResponse(taiheValue);
        if (ret != OHOS::DrmStandard::DRM_INNER_ERR_OK) {
...
CertificateStatus MediaKeySystemImpl::GetCertificateStatus()
{
    ...
    OHOS::DrmStandard::IMediaKeySystemService::CertificateStatus certStatus =
        OHOS::DrmStandard::IMediaKeySystemService::CertificateStatus::CERT_STATUS_UNAVAILABLE;
    CertificateStatus::key_t certStatusInfo;
    DrmTaiheUtils::GetEnumKeyByValue<CertificateStatus>(certStatus, certStatusInfo);
    if (mediaKeySystemImpl_ != nullptr) {
...
optional<MediaKeySession> MediaKeySystemImpl::CreateMediaKeySessionWithLevel(ContentProtectionLevel level)
{
    ...
    OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel securityLevel =
        static_cast<OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel>(taiheContentProtectionLevel);
    if (securityLevel <= OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel::
        CONTENT_PROTECTION_LEVEL_UNKNOWN || securityLevel >= OHOS::DrmStandard::IMediaKeySessionService::
    ...
    if (mediaKeySystemImpl_ != nullptr) {
        int32_t ret = mediaKeySystemImpl_->CreateMediaKeySession(
            (OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel)securityLevel, &keySessionImpl);
        if (ret != OHOS::DrmStandard::DRM_INNER_ERR_OK) {
...
optional<MediaKeySession> MediaKeySystemImpl::CreateMediaKeySession()
{
    ...
    auto res = optional<MediaKeySession>(std::nullopt);
    OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel securityLevel =
        OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel::CONTENT_PROTECTION_LEVEL_UNKNOWN;
    OHOS::sptr<OHOS::DrmStandard::MediaKeySessionImpl> keySessionImpl = nullptr;
    if (mediaKeySystemImpl_ != nullptr) {
        int32_t ret = mediaKeySystemImpl_->CreateMediaKeySession(
            (OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel)securityLevel, &keySessionImpl);
...
OfflineMediaKeyStatus MediaKeySystemImpl::GetOfflineMediaKeyStatus(array_view<uint8_t> mediaKeyId)
{
    ...
    OHOS::DrmStandard::IMediaKeySessionService::OfflineMediaKeyStatus offlineMediaKeyStatus =
        OHOS::DrmStandard::IMediaKeySessionService::OFFLINELICENSESTATUS_UNKNOWN;
    OfflineMediaKeyStatus::key_t offlineMediaKeyStatusValue;
    DrmTaiheUtils::GetEnumKeyByValue<OfflineMediaKeyStatus>(offlineMediaKeyStatus, offlineMediaKeyStatusValue);
    ...
    DrmTaiheUtils::GetEnumKeyByValue<OfflineMediaKeyStatus>(
        offlineMediaKeyStatus, offlineMediaKeyStatusValue);
    return OfflineMediaKeyStatus(offlineMediaKeyStatusValue);
}
...
bool IsMediaKeySystemSupportedWithThreeArgs(string_view name, string_view mimeType, ContentProtectionLevel level)
{
    ...
    OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel securityLevel =
        static_cast<OHOS::DrmStandard::IMediaKeySessionService::ContentProtectionLevel>(taiheContentProtectionLevel);
    if ((securityLevel <= OHOS::DrmStandard::IMediaKeySessionService::CONTENT_PROTECTION_LEVEL_UNKNOWN) ||
        (securityLevel >= OHOS::DrmStandard::IMediaKeySessionService::CONTENT_PROTECTION_LEVEL_MAX)) {
