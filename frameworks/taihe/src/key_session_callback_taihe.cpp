    ...
    std::vector<KeysInfo> &statusTableVec)
{
    for (const auto &itemTmp : statusTable) {
        ...
        switch (itemTmp.second) {
            case OHOS::DrmStandard::MEDIA_KEY_SESSION_KEY_STATUS_USABLE:
                value = "USABLE";
                break;
            case OHOS::DrmStandard::MEDIA_KEY_SESSION_KEY_STATUS_EXPIRED:
                value = "EXPIRED";
                break;
            case OHOS::DrmStandard::MEDIA_KEY_SESSION_KEY_STATUS_OUTPUT_NOT_ALLOWED:
                value = "OUTPUT_NOT_ALLOWED";
                break;
            case OHOS::DrmStandard::MEDIA_KEY_SESSION_KEY_STATUS_PENDING:
                value = "PENDING";
                break;
            case OHOS::DrmStandard::MEDIA_KEY_SESSION_KEY_STATUS_INTERNAL_ERROR:
                value = "INTERNAL_ERROR";
                break;
            case OHOS::DrmStandard::MEDIA_KEY_SESSION_KEY_STATUS_USABLE_IN_FUTURE:
