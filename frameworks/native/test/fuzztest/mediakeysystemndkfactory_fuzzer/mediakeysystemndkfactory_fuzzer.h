...
#ifndef DRM_MEDIAKEYSYSTEMNDKFACTORY_FUZZER_H
#define DRM_MEDIAKEYSYSTEMNDKFACTORY_FUZZER_H
...
class MediaKeySystemFactoryNdkFuzzer : public NoCopyable {
private:
    bool wisePlay = false;

public:
    MediaKeySystemFactoryNdkFuzzer();
    ~MediaKeySystemFactoryNdkFuzzer();
    bool FuzzTestSystemFactoryNdk(uint8_t *rawData, size_t size);
    void GetUuid();
    void IsWisePlay();
