...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_GenerateOfflineReleaseRequestNormal_045, TestSize.Level0)
{
    ...
    unsigned char releaseRequest[12288] = { 0 }; // 12288:request len
    int32_t releaseRequestLen = 12288; // 12288:request len
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_GenerateOfflineReleaseRequestAbNormal_046, TestSize.Level0)
{
    ...
    errNo = OH_MediaKeySession_GenerateOfflineReleaseRequest(nullptr, onlineMediaKeyId, onlineMediaKeyIdLen,
        releaseRequest, &releaseRequestLen);
    EXPECT_NE(errNo, DRM_ERR_OK);
    releaseRequestLen = 12288; // 12288:request len
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_MediaKeySystemDestroyAbNormal_071, TestSize.Level0)
{
    ...
    EXPECT_NE(errNo, DRM_ERR_OK);
    char value[32];
    errNo = OH_MediaKeySystem_GetConfigurationString(mediaKeySystem, "testConfigurationString", value, 32);
    EXPECT_NE(errNo, DRM_ERR_OK);
    unsigned char testArray[5] = {1, 2, 3, 4, 5};
    errNo = OH_MediaKeySystem_SetConfigurationByteArray(mediaKeySystem, "testConfigurationByteArray", testArray,
        sizeof(testArray));
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_GetMediakeySystemsNormal, TestSize.Level0)
{
    ...
    DRM_MediaKeySystemDescription *descriptions = new DRM_MediaKeySystemDescription();
    uint32_t count;
    memcpy_s(descriptions->name, MAX_MEDIA_KEY_SYSTEM_NAME_LEN, uuid_str, MAX_MEDIA_KEY_SYSTEM_NAME_LEN - 1);
    count = (uint32_t)strlen(descriptions->name);
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_CreateMediaKeySessionAbNormal_001, TestSize.Level0)
{
    Drm_ErrCode errNo = DRM_ERR_UNKNOWN;
    MediaKeySystem *mediaKeySystem = nullptr;
    MediaKeySession *mediaKeySession = nullptr;
    ...
    errNo = OH_MediaKeySystem_Create(test, &mediaKeySystem);
    EXPECT_NE(mediaKeySystem, nullptr);
    EXPECT_NE(errNo, DRM_ERR_OK);
    errNo = OH_MediaKeySystem_SetMediaKeySystemCallback(mediaKeySystem, &TestSystemEventCallBack);
    EXPECT_NE(errNo, DRM_ERR_OK);
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_CreateMediaKeySessionAbNormal_002, TestSize.Level0)
{
    Drm_ErrCode errNo = DRM_ERR_UNKNOWN;
    MediaKeySystem *mediaKeySystem = nullptr;
    MediaKeySession *mediaKeySession = nullptr;
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_CreateMediaKeySessionAbNormal_003, TestSize.Level0)
{
    Drm_ErrCode errNo = DRM_ERR_UNKNOWN;
    MediaKeySystem *mediaKeySystem = nullptr;
    MediaKeySession *mediaKeySession = nullptr;
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_CreateMediaKeySessionAbNormal_004, TestSize.Level0)
{
    Drm_ErrCode errNo = DRM_ERR_UNKNOWN;
    MediaKeySystem *mediaKeySystem = nullptr;
    MediaKeySession *mediaKeySession = nullptr;
    DRM_ContentProtectionLevel contentProtectionLevel = CONTENT_PROTECTION_LEVEL_SW_CRYPTO;
    const char* test = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    errNo = OH_MediaKeySystem_Create(test, &mediaKeySystem);
    EXPECT_NE(mediaKeySystem, nullptr);
    EXPECT_NE(errNo, DRM_ERR_OK);
    errNo = OH_MediaKeySystem_SetMediaKeySystemCallback(mediaKeySystem, &TestSystemEventCallBack);
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_CreateMediaKeySessionAbNormal_005, TestSize.Level0)
{
    Drm_ErrCode errNo = DRM_ERR_UNKNOWN;
    MediaKeySystem *mediaKeySystem = nullptr;
    MediaKeySession *mediaKeySession = nullptr;
    DRM_ContentProtectionLevel contentProtectionLevel = CONTENT_PROTECTION_LEVEL_SW_CRYPTO;
    const char* test = "clearplay";
    errNo = OH_MediaKeySystem_Create(test, &mediaKeySystem);
    EXPECT_NE(mediaKeySystem, nullptr);
    EXPECT_NE(errNo, DRM_ERR_OK);
    errNo = OH_MediaKeySystem_SetMediaKeySystemCallback(mediaKeySystem, &TestSystemEventCallBack);
...
HWTEST_F(DrmFrameworkUnitTest, Drm_unittest_CreateMediaKeySessionAbNormal_006, TestSize.Level0)
{
    Drm_ErrCode errNo = DRM_ERR_UNKNOWN;
    MediaKeySystem *mediaKeySystem = nullptr;
    MediaKeySession *mediaKeySession = nullptr;
    DRM_ContentProtectionLevel contentProtectionLevel = CONTENT_PROTECTION_LEVEL_SW_CRYPTO;
    const char* test = "wiseplay";
    errNo = OH_MediaKeySystem_Create(test, &mediaKeySystem);
    EXPECT_NE(mediaKeySystem, nullptr);
    EXPECT_NE(errNo, DRM_ERR_OK);
    errNo = OH_MediaKeySystem_SetMediaKeySystemCallback(mediaKeySystem, &TestSystemEventCallBack);
