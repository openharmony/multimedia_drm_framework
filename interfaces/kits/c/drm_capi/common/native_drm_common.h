...
typedef struct OH_DRM_Uint8CharBufferPair {
    ...
    OH_DRM_Uint8Buffer uintData;
    /* Value buffer in chars. */
    OH_DRM_CharBuffer charData;
 ...
 * @version 1.0
 */
typedef OH_DrmErrCode (*OH_MediaKeySessionKeyChangeCallback)(OH_DRM_KeysInfo *keysInfo,
    bool hasNewGoodKeys);
