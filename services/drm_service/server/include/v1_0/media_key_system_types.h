...
bool LicenseRequestInfoBlockMarshalling(OHOS::MessageParcel &data,
    const OHOS::HDI::Drm::V1_0::LicenseRequestInfo &dataBlock);

bool LicenseRequestInfoBlockUnmarshalling(OHOS::MessageParcel &data,
    OHOS::HDI::Drm::V1_0::LicenseRequestInfo &dataBlock);
