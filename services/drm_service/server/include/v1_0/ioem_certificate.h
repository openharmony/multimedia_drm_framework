...
#ifndef OHOS_HDI_DRM_V1_0_IOEMCERTIFICATE_H
#define OHOS_HDI_DRM_V1_0_IOEMCERTIFICATE_H
...
public:
    DECLARE_HDI_DESCRIPTOR(u"ohos.hdi.drm.v1_0.IOemCertificate");
...
#endif // OHOS_HDI_DRM_V1_0_IOEMCERTIFICATE_H