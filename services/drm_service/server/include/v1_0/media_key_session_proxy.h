...
public:
    explicit MediaKeySessionProxy(const sptr<IRemoteObject> &remote)
        : IProxyBroker<OHOS::HDI::Drm::V1_0::IMediaKeySession>(remote)
    {}
    ...
    int32_t CheckLicenseStatus(
        std::map<std::string, OHOS::HDI::Drm::V1_0::MediaKeySessionKeyStatus> &licenseStatus) override;
    ...
    static int32_t CheckLicenseStatus_(
        std::map<std::string, OHOS::HDI::Drm::V1_0::MediaKeySessionKeyStatus> &licenseStatus,
        const sptr<IRemoteObject> remote);
