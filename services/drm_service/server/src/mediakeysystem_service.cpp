...
int32_t MediaKeySystemService::Release()
{
    ...
    sptr<IMediaKeySystemServiceOperatorsCallback> keySystemOperatoersCallbackPromote = nullptr;

    {
        std::lock_guard<std::recursive_mutex> lock(callbackMutex_);
        int32_t currentPid = IPCSkeleton::GetCallingPid();
        DRM_DEBUG_LOG("MediaKeySystemService GetCallingPID: %{public}d", currentPid);
        keySystemOperatoersCallbackPromote = keySystemOperatoersCallback_.promote();
    }
...
{
    std::lock_guard<std::recursive_mutex> lock(callbackMutex_);
    DRM_CHECK_AND_RETURN_RET_LOG(callback.promote() != nullptr,
        DRM_INNER_ERR_INVALID_VAL,
        "SetMediaKeySystemServiceOperatorsCallback callback is null");
...
int32_t MediaKeySystemService::GenerateKeySystemRequest(std::vector<uint8_t> &request, std::string &defaultUrl)
{
    ...
    if (ret != DRM_INNER_ERR_OK) {
        DRM_ERR_LOG("GenerateKeySystemRequest failed. ret is %x", ret);
...
int32_t MediaKeySystemService::ProcessKeySystemResponse(const std::vector<uint8_t> &response)
{
    ...
    if (ret != DRM_INNER_ERR_OK) {
        DRM_ERR_LOG("ProcessKeySystemResponse failed. ret is %x", ret);
...
int32_t MediaKeySystemService::SetConfigurationString(const std::string &configName, const std::string &value)
{
    ...
    if (ret != DRM_INNER_ERR_OK) {
        DRM_ERR_LOG("SetConfiguration failed. ret is %x", ret);
    }
    return ret;
}
...
int32_t MediaKeySystemService::GetConfigurationString(const std::string &configName, std::string &value)
{
    ...
    if (ret != DRM_INNER_ERR_OK) {
        DRM_ERR_LOG("GetConfiguration failed. ret is %x", ret);
    }
    return ret;
}
...
int32_t MediaKeySystemService::GetConfigurationByteArray(const std::string &configName, std::vector<uint8_t> &value)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "GetConfiguration failed. ret is %x", ret);
    ...
    sptr<IMediaKeySessionService> &keySessionProxy)
{
    ...
    if (hdiMediaKeySession == nullptr) {
        DRM_ERR_LOG("hdiKeySystem_ CreateMediaKeySession failed. ret is %x", ret);
...
int32_t MediaKeySystemService::SetBundleName()
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "SetBundleName failed. ret is %x", ret);
    return ret;
}
...
int32_t MediaKeySystemService::SetApiTargetVersion()
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "SetApiTargetVersion failed. ret is %x", ret);
    return ret;
}
...
int32_t MediaKeySystemService::CloseMediaKeySessionService(sptr<MediaKeySessionService> sessionService)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(sessionService != nullptr, ret, "MediaKeySystemService sessionService is null");
...
int32_t MediaKeySystemService::GetStatistics(std::vector<MetircKeyValue> &metrics)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "GetStatistics failed. ret is %x", ret);
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(metrics.size() != 0, DRM_INNER_ERR_BASE, "GetStatistics failed.");
    return ret;
}
...
int32_t MediaKeySystemService::GetMaxContentProtectionLevel(ContentProtectionLevel &securityLevel)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "GetMaxContentProtectionLevel failed. ret is %x", ret);
...
int32_t MediaKeySystemService::GetCertificateStatus(CertificateStatus &certStatus)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "GetCertificateStatus failed. ret is %x", ret);
...
int32_t MediaKeySystemService::GetOfflineMediaKeyIds(std::vector<std::vector<uint8_t>> &licenseIds)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "GetOfflineMediaKeyIds failed. ret is %x", ret);
    return ret;
}
    ...
    OfflineMediaKeyStatus &status)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "GetOfflineMediaKeyStatus failed. ret is %x", ret);
...
int32_t MediaKeySystemService::ClearOfflineMediaKeys(const std::vector<uint8_t> &licenseId)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(ret == DRM_INNER_ERR_OK, ret, "ClearOfflineMediaKeys failed. ret is %x", ret);
    return ret;
}
...
int32_t MediaKeySystemService::SetCallback(const sptr<IMediaKeySystemServiceCallback> &callback)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(hdiKeySystem_ != nullptr, DRM_INNER_ERR_SERVICE_FATAL_ERROR,
        "hdiKeySystem_ is nullptr!");
    DRM_CHECK_AND_RETURN_RET_LOG(callback != nullptr, ret, "SetCallback callback is nullptr, ret is %x", ret);
    callback_ = callback;
    ...
    const std::vector<uint8_t> &data)
{
    ...
    DRM_CHECK_AND_RETURN_RET_LOG(
        callback_ != nullptr, DRM_INNER_ERR_OPERATION_NOT_PERMITTED, "SendEvent failed because callback is nullptr");
